...
**资源** 是保存资源数据的文件。
例如，纹理、模型或场景文件都是资源。
资源可以从 Flax 外部创建的文件导入，例如 3D 模型、音频文件或纹理。
还有一些资源类型可以在 Flax 编辑器内部创建，例如物理材质或场景。

本节涵盖了在 Flax 中处理资源的基本原则。
...
<h3><a href="../../editor/windows/content-window.md">内容窗口</a></h3>
<p>查看内容窗口文档。</p>
</div>
...
<h3><a href="../../physics/physical-material.md">物理材质</a></h3>
</div>

<div class="frontpage-section">
<a href="../../physics/colliders/collision-data.md"><img src="../../physics/colliders/media/collision-data-icon.jpg"></a>
<h3><a href="../../physics/colliders/collision-data.md">碰撞数据</a></h3>
</div>
