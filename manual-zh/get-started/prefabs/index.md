...
![编辑器中的预制体实例](media/prefab-instance.png)

选择预制体实例后，*属性窗口* 会在面板顶部显示两个额外的按钮：**选择预制体** 和 **查看更改**。

![预制体实例差异弹出窗口](media/prefab-instance-buttons.png)
...
![预制体实例差异弹出窗口](media/prefab-instance-diff-popup.png)

你还可以看到应用于预制体实例的逐属性修改。编辑器通过高亮显示已更改属性的标签来显示它们，如下图所示。你可以右键单击它并还原应用于此属性的更改（支持撤销）。

![预制体实例差异弹出窗口](media/prefab-instance-property-diff.png)
