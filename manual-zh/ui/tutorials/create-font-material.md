...
![生成文本渲染](media/spawn-text-render.png)
...
![分配自定义字体材质](media/set-custom-font-material.png)

## 6. 查看结果！

![结果](media/custom-font-material-result.png)
...
![自定义字体材质](media/custom-font-material-graph-2.png)
