...
![编辑画笔](media/brush-set-type.png)

# 纹理画笔

绘制纹理的画笔。

![纹理画笔](media/brush-texture.png)

# 精灵画笔

从精灵图集中绘制单个精灵的画笔。

![精灵画笔](media/brush-sprite.png)
...
![材质画笔](media/brush-material.png)

# 纯色画笔

用单一纯色填充区域的画笔。

![纯色画笔](media/brush-solid-color.png)

# 线性渐变画笔

在区域的顶部和底部边缘之间绘制线性双色渐变的画笔。

![线性渐变画笔](media/brush-linear-gradient.png)

# 9-Slicing 画笔

9-Slicing 是 2D 图形中使用的一种技术，它将单个图像分割为 9 个区域，这些区域分别进行缩放，以防止图像在不同尺寸和纵横比下显示时出现拉伸。在大多数情况下，它对于防止面板和按钮的图像边框拉伸非常有用。

![9-Slicing 画笔](media/9slicing.gif)
