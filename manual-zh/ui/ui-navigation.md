* # UI 导航
  ...
  **UI 导航** 允许通过键盘方向键或游戏手柄按键等输入操作在用户界面中执行焦点导航。此功能对于主机游戏或其他支持游戏手柄的游戏至关重要，这些游戏旨在无需鼠标输入或用户触摸输入即可提供完整的 UI 可用性。
  ...
  ![UI 导航设置](/manual/media/ui-navigation-settings.png)
  ...
  ![控件上的 UI 导航设置](/manual/media/ui-navigation-control.png)
  ...
  * `OnNavigate` 方法来重写默认的导航流程逻辑。
  ...
  ![编辑器中的 UI 导航](/manual/media/ediotr-ui-navigation.gif)
