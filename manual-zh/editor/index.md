...
![Flax 编辑器](media/title.jpg)

**Flax 编辑器** 是一款用于使用 Flax 引擎开发游戏的全能型应用程序。
本文档章节涵盖了最重要的主题，并描述了如何使用所有编辑器工具。
遵循这些说明，让你的游戏开发更加稳健！
