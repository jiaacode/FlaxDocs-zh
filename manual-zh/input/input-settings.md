...
2. 右键单击并选择选项 **新建 -> 设置**，指定资源名称（例如 *Input Settings*）并按 *Enter*
   <br>![教程](media/new-settings.jpg)

3. 选择选项 **输入设置** 并按下 **创建** 按钮
   <br>![教程](media/input-settings-new.jpg)

4. 双击资源以打开并编辑它。
   <br>![教程](media/empty-input-settings.jpg)
...
![使用输入设置](media/use-input-settings.jpg)

## 操作映射

![操作映射](media/input-action-mappings.jpg)
...
![轴映射](media/input-axis-mappings.jpg)
...
![使用键盘选择键盘按键枚举](media/keyboard-navigation-context-menu.gif)
