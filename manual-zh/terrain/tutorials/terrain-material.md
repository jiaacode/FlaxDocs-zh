...
![地形材质领域](media/terrain-material-domain.png)

## 3. 创建材质

添加各种景观纹理，并使用纹理层权重实现简单的线性混合（如下图所示）。

![创建的材质](media/terrain-material-example.png)

## 4. 将材质分配给地形

保存创建的材质，并将其分配给地形的 **材质** 属性。

![地形材质](media/terrain-material-set.png)

你也可以使用工具箱覆盖每个块的材质。

![地形块材质覆盖](media/per-chunk-material-override.png)

## 5. 绘制层

要使用绘制工具，请选择 **工具箱 -> 绘制 -> 选择层**，然后选择要绘制的地形 Actor。

![绘制地形工具](media/paint-layer-tool.png)
