...
![地形领域材质](/manual/tutorials/media/terrain-material-domain.png)

然后你可以使用地形层权重和地形孔洞遮罩节点来实现特定功能。

![地形材质示例](/manual/tutorials/media/terrain-material-example.png)

<p>
![地形孔洞遮罩](/manual/media/terrain-holes-material.png)
</p>

## 地形层

![地形层混合](/manual/media/height-layer-blend-terrain.png)
