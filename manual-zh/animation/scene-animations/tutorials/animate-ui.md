...
![UI 动画](media/scene-anims-ui.gif)
...
![添加控件子轨道](media/add-control-track.png)

### 3. 添加子轨道

使用 **+** 按钮并选择你想要制作动画的控件属性。你可以同时为多个属性和字段制作动画，也可以调用控件方法。

![添加旋转子轨道](media/control-animate-properties.png)
